...
class FileTemplateModule extends ResourceModule {
  ...
  FileTemplateModule(super.file, super.action,
      {super.allowedActions = const ['template'], super.fileSystem}) {
    updateState({
  ...
  void _loadConfiguration() {
    ...
    // Exclude system properties like status, timestamp, sha256, id, type
    final systemProps = {'status', 'timestamp', 'sha256', 'id', 'type'};
