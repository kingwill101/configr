...
impl PlatformWindow for MacWindow {
    ...
    fn prompt(
        ...
        // any button with a title of âCancelâ has a key equivalent of Escape,
        // and any button with the title âDonât Saveâ has a key equivalent of Command-D (but only if itâs not the first button).
        // ```
        //
