...
fn test_typing_multiple_new_injections(cx: &mut AppContext) {
    let (buffer, syntax_map) = test_edit_sequence(
        ...
        &[
            ...
            "fn a() { test_macroÂ«!Â» }",
            "fn a() { test_macro!Â«()Â» }",
            "fn a() { test_macro!(Â«bÂ») }",
            "fn a() { test_macro!(bÂ«.Â») }",
            "fn a() { test_macro!(b.Â«cÂ») }",
            "fn a() { test_macro!(b.cÂ«()Â») }",
            "fn a() { test_macro!(b.c(Â«vecÂ»)) }",
            "fn a() { test_macro!(b.c(vecÂ«!Â»)) }",
            "fn a() { test_macro!(b.c(vec!Â«[]Â»)) }",
            "fn a() { test_macro!(b.c(vec![Â«dÂ»])) }",
            "fn a() { test_macro!(b.c(vec![dÂ«.Â»])) }",
            "fn a() { test_macro!(b.c(vec![d.Â«eÂ»])) }",
        ],
        cx,
    );
    ...
    assert_capture_ranges(
        ...
        &buffer,
        &["field"],
        "fn a() { test_macro!(b.Â«cÂ»(vec![d.Â«eÂ»])) }",
    );
}
...
fn test_joining_injections_with_child_injections(cx: &mut AppContext) {
    ...
    assert_capture_ranges(
        ...
        fn a() {
            b!(
                c![one.Â«twoÂ».Â«threeÂ»],
                d![four.Â«fiveÂ».Â«sixÂ»],
                f![seven.Â«eightÂ»],
            );
        }
        ",
