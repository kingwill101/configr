...
mod tests {
    ...
    fn test_previous_word_start(cx: &mut gpui::AppContext) {
        ...
        assert("\nlorem\nË   Ëipsum", cx);
        assert("\n\nË\nË", cx);
        assert("    Ëlorem  Ëipsum", cx);
        assert("loremË-Ëipsum", cx);
        assert("loremË-#$@Ëipsum", cx);
        assert("Ëlorem_Ëipsum", cx);
        assert(" ËdefÎ³Ë", cx);
        assert(" ËbcÎË", cx);
        assert(" abËââËcd", cx);
    }
    ...
    fn test_previous_subword_start(cx: &mut gpui::AppContext) {
        ...
        assert("lorem_ËipËsum", cx);
        assert("lorem_ËipsumË", cx);
        assert("Ëlorem_Ëipsum", cx);
        assert("lorem_Ëipsum_Ëdolor", cx);
        assert("loremËIpËsum", cx);
        assert("loremËIpsumË", cx);
    ...
    fn test_next_subword_end(cx: &mut gpui::AppContext) {
        ...
        // Subword boundaries are respected
        assert("loËremË_ipsum", cx);
        assert("ËloremË_ipsum", cx);
        assert("loremË_ipsumË", cx);
        assert("loremË_ipsumË_dolor", cx);
        assert("loËremËIpsum", cx);
        assert("loremËIpsumËDolor", cx);
    ...
    fn test_surrounding_word(cx: &mut gpui::AppContext) {
        ...
        assert("ËËloremË  ipsum", cx);
        assert("ËloËremË  ipsum", cx);
        assert("ËloremËË  ipsum", cx);
        assert("loremË Ë  Ëipsum", cx);
        assert("lorem\nËËË\nipsum", cx);
        assert("lorem\nËËipsumË", cx);
        assert("loremË,ËË ipsum", cx);
        assert("ËloremËË, ipsum", cx);
