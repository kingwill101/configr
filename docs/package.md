...
See [`examples/package/`](../examples/package/) for runnable config files for every manager.

| Manager | Example |
|---------|---------|
| APT | [`examples/package/apt/config`](../examples/package/apt/config) |
| Brew | [`examples/package/brew/config`](../examples/package/brew/config) |
| DNF | [`examples/package/dnf/config`](../examples/package/dnf/config) |
| Docker | [`examples/package/docker/config`](../examples/package/docker/config) |
| Flatpak | [`examples/package/flatpak/config`](../examples/package/flatpak/config) |
| npm | [`examples/package/npm/config`](../examples/package/npm/config) |
| Pacman | [`examples/package/pacman/config`](../examples/package/pacman/config) |
| Pamac | [`examples/package/pacman/pamac/config`](../examples/package/pacman/pamac/config) |
| pip | [`examples/package/pip/config`](../examples/package/pip/config) |
| Snap | [`examples/package/snap/config`](../examples/package/snap/config) |
| YUM | [`examples/package/yum/config`](../examples/package/yum/config) |
